...
export const updateUserSchema = z.object({
  ...
  banReason: z.string().max(500, 'Ban reason must be less than 500 characters').optional(),
  banExpires: z.string().datetime('Invalid ban expiry date').transform((val) => new Date(val)).optional(),
});
...
export const changePasswordSchema = z.object({
  ...
  newPassword: z.string().min(6, 'New password must be at least 6 characters').max(128, 'New password must be less than 128 characters'),
...
export const userQuerySchema = z.object({
  role: userRoleSchema.optional(),
  banned: z.string().optional().transform((val) => val === 'true'),
...
export const banUserSchema = z.object({
  ...
  expiresAt: z.string().datetime('Invalid ban expiry date').transform((val) => new Date(val)).optional(),
});
